...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inv}\;\Varid{x}\mathrel{=}\p2\comp (\Varid{cataNat}\;\conj{\alt{\underline{(\mathrm{1}\mathbin{-}\Varid{x})}}{\uncurry{(\mathbin{*})}\comp \conj{\underline{(\mathrm{1}\mathbin{-}\Varid{x})}}{\p1}}}{\alt{\Varid{fromIntegral}\comp \Varid{one}}{\uncurry{(\mathbin{+})}}}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Testes com o QuickCheck}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 inv1}\mathbin{::}\Conid{Float}\to \Conid{Integer}\to \Conid{Property}{}\<[E]%
\\
\>[B]{}\Varid{prop\char95 inv1}\;\Varid{x}\;\Varid{n}\mathrel{=}(\Varid{x}\geq \mathrm{1})\mathbin{==>}(\Varid{inv}\;\Varid{x}\;\mathrm{0}\equiv \mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 inv2}\mathbin{::}\Conid{Float}\to \Conid{Integer}\to \Conid{Property}{}\<[E]%
\\
\>[B]{}\Varid{prop\char95 inv2}\;\Varid{x}\;\Varid{n}\mathrel{=}(\Varid{x}\geq \mathrm{1})\mathbin{==>}(\Varid{inv}\;\mathrm{1}\;\mathrm{10}\equiv \Varid{inv}\;\mathrm{1}\;\mathrm{20}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\start
  \ensuremath{\begin{lcbr}\Varid{inv\char95 p1}\;\Varid{x}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{h1},\Varid{h2}\mskip1.5mu]\comp \Conid{F}\mathbin{<}\Varid{inv\char95 p1}\;\Varid{x},\Varid{aux\char95 inv}\;\Varid{x}\mathbin{>}\\\Varid{aux\char95 inv}\;\Varid{x}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{k1},\Varid{k2}\mskip1.5mu]\comp \Conid{F}\mathbin{<}\Varid{inv\char95 p1}\;\Varid{x},\Varid{aux\char95 inv}\;\Varid{x}\mathbin{>}\end{lcbr}} 
%
\just={ definição de F }
%
  \ensuremath{\begin{lcbr}\Varid{inv\char95 p1}\;\Varid{x}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{h1},\Varid{h2}\mskip1.5mu]\comp (\Varid{id}\mathbin{+}\Varid{inv\char95 p1}\;\Varid{x})\\\Varid{aux\char95 inv}\;\Varid{x}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{k1},\Varid{k2}\mskip1.5mu]\comp (\Varid{id}\mathbin{+}\Varid{aux\char95 inv}\;\Varid{x})\end{lcbr}}
%
\just={ Absorção-+, def in}
%
  \ensuremath{\begin{lcbr}\begin{lcbr}\Varid{inv\char95 p1}\;\Varid{x}\comp \underline{\mathrm{0}}\mathrel{=}\Varid{h1}\\\Varid{inv\char95 p1}\;\Varid{x}\comp \mathsf{succ}\mathrel{=}\Varid{h2}\comp (\Varid{inv\char95 p1}\;\Varid{x})\end{lcbr}\\\begin{lcbr}\Varid{aux\char95 inv}\;\Varid{x}\comp \underline{\mathrm{0}}\mathrel{=}\Varid{k1}\\\Varid{aux\char95 inv}\;\Varid{x}\comp \mathsf{succ}\mathrel{=}\Varid{k2}\comp (\Varid{aux\char95 inv}\;\Varid{x})\end{lcbr}\end{lcbr}}
      .
%
\just={ Igualdade Extensional}
%
  \ensuremath{\begin{lcbr}\begin{lcbr}\Varid{inv\char95 p1}\;\Varid{x}\;(\underline{\mathrm{0}}\comp \Varid{x})\mathrel{=}\Varid{h1}\;\Varid{x}\\\Varid{inv\char95 p1}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{h2}\;(\Varid{inv\char95 p1}\;\Varid{x})\;(\Varid{n}\mathbin{+}\mathrm{1})\end{lcbr}\\\begin{lcbr}\Varid{aux\char95 inv}\;\Varid{x}\;(\underline{\mathrm{0}}\comp \Varid{x})\mathrel{=}\Varid{k1}\;\Varid{x}\\\Varid{aux\char95 inv}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{k2}\;(\Varid{aux}\;\Varid{x})\;(\Varid{n}\mathbin{+}\mathrm{1})\end{lcbr}\end{lcbr}}
      .
%
\just={ Natural-cons}
%
  \ensuremath{\begin{lcbr}\begin{lcbr}\Varid{inv\char95 p1}\;\Varid{x}\;\underline{\mathrm{0}}\mathrel{=}\underline{\mathrm{1}}\\\Varid{inv\char95 p1}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{h2}\;(\Varid{inv\char95 p1}\;\Varid{x})\;(\Varid{n}\mathbin{+}\mathrm{1})\end{lcbr}\\\begin{lcbr}\Varid{aux\char95 inv}\;\Varid{x}\;\underline{\mathrm{0}}\mathrel{=}\underline{(\mathrm{1}\mathbin{-}\Varid{x})}\\\Varid{aux\char95 inv}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{k2}\;(\Varid{aux\char95 inv}\;\Varid{x})\;(\Varid{n}\mathbin{+}\mathrm{1})\end{lcbr}\end{lcbr}}
        .
%
\just={ Verifica-se que }
%
  <inv\_p1 x, aux\_inv x> = (\ensuremath{\mathbin{<}[\mskip1.5mu \Varid{h1},\Varid{h2}\mskip1.5mu],[\mskip1.5mu \Varid{k1},\Varid{k2}\mskip1.5mu]\mathbin{>}}) 
  .
%  
\just={------------------}
% 
   Onde: \ensuremath{\begin{lcbr}\begin{lcbr}\Varid{h1}\mathrel{=}\underline{(\mathrm{1})}\\\Varid{h2}\mathrel{=}\uncurry{(\mathbin{*})}\mathbin{.<}\underline{(\mathrm{1}\mathbin{-}\Varid{x})},\p1\mathbin{>}\end{lcbr}\\\begin{lcbr}\Varid{k1}\mathrel{=}\underline{(\mathrm{1}\mathbin{-}\Varid{x})}\\\Varid{k2}\mathrel{=}\uncurry{(\mathbin{+})}\end{lcbr}\end{lcbr}}
        .
%
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{wc\char95 w\char95 final}\mathbin{::}[\mskip1.5mu \Conid{Char}\mskip1.5mu]\to \Conid{Integer}{}\<[E]%
\\
\>[B]{}\Varid{wc\char95 w\char95 final}\mathrel{=}\Varid{wrapper}\comp \Varid{worker}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{sep}\;\Varid{c}\mathrel{=}(\Varid{c}\equiv \text{\tt '~'}\mathrel{\vee}\Varid{c}\equiv \text{\tt '\char92 n'}{}\<[33]%
\>[33]{}\mathrel{\vee}\Varid{c}\equiv \text{\tt '\char92 t'}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  gene é a condicional de McCarthy}{}\<[E]%
\\
\>[B]{}\Varid{gene2}\mathrel{=}\Varid{cond}\;(\uncurry{(\mathrel{\wedge})}\comp \conj{\neg \comp \Varid{sep}\comp \p1}{\p2\comp \p2})\;((\mathrm{1}\mathbin{+})\comp (\p1\comp \p2))\;(\p1\comp \p2){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{wrapper}\mathrel{=}\p1{}\<[E]%
\\
\>[B]{}\Varid{worker}\mathrel{=}(\Varid{cataList}\;\alt{\conj{\Varid{zero}}{\Varid{true}}}{\conj{\Varid{gene2}}{\Varid{sep}\comp \p1}}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Testes com o QuickCheck}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 wc1}\mathbin{::}[\mskip1.5mu \Conid{Char}\mskip1.5mu]\to \Conid{Property}{}\<[E]%
\\
\>[B]{}\Varid{prop\char95 wc1}\;\Varid{l}\mathrel{=}(\Varid{l}\not\equiv [\mskip1.5mu \mskip1.5mu])\mathbin{==>}((\Varid{wc\char95 w\char95 final}\;\text{\tt \char34 as~\char34})\equiv \mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 wc2}\mathbin{::}[\mskip1.5mu \Conid{Char}\mskip1.5mu]\to \Conid{Property}{}\<[E]%
\\
\>[B]{}\Varid{prop\char95 wc2}\;\Varid{l}\mathrel{=}(\Varid{l}\not\equiv [\mskip1.5mu \mskip1.5mu])\mathbin{==>}((\Varid{wc\char95 w\char95 final}\;[\mskip1.5mu \mskip1.5mu])\equiv \mathrm{0}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 wc3}\mathbin{::}[\mskip1.5mu \Conid{Char}\mskip1.5mu]\to \Conid{Property}{}\<[E]%
\\
\>[B]{}\Varid{prop\char95 wc3}\;\Varid{l}\mathrel{=}(\Varid{l}\not\equiv [\mskip1.5mu \mskip1.5mu])\mathbin{==>}((\Varid{wc\char95 w\char95 final}\;\text{\tt \char34 ~as~~b~~~\char34})\equiv \mathrm{2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\start
  \ensuremath{\begin{lcbr}\Varid{f}\mathrel{=}\Varid{wc}\\\Varid{g}\mathrel{=}\Varid{lookahead}\end{lcbr}} 
%
\just={ Lei fokkinga }
%
  \ensuremath{\begin{lcbr}\Varid{wc}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{h1},\Varid{h2}\mskip1.5mu]\comp \Conid{F}\mathbin{<}\Varid{f},\Varid{g}\mathbin{>}\\\Varid{lookahead}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{k1},\Varid{k2}\mskip1.5mu]\comp \Conid{F}\mathbin{<}\Varid{f},\Varid{g}\mathbin{>}\end{lcbr}}
%
\just={ definição de F }
%
  \ensuremath{\begin{lcbr}\Varid{wc}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{h1},\Varid{h2}\mskip1.5mu]\comp (\Varid{id}\mathbin{+}\Varid{id}\;\Varid{x}\mathbin{<}\Varid{wc},\Varid{lookahead}\mathbin{>})\\\Varid{lookahead}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{k1},\Varid{k2}\mskip1.5mu]\comp (\Varid{id}\mathbin{+}\Varid{id}\;\Varid{x}\mathbin{<}\Varid{wc},\Varid{look}\mathbin{>})\end{lcbr}}
%
\just={ def in}
%
  \ensuremath{\begin{lcbr}\begin{lcbr}\Varid{wc}\comp \Varid{nil}\mathrel{=}\Varid{h1}\\\Varid{wc}\comp \Varid{cons}\mathrel{=}\Varid{h2}\;(\Varid{id}\;\Varid{x}\mathbin{<}\Varid{wc},\Varid{lookahead}\mathbin{>})\end{lcbr}\\\begin{lcbr}\Varid{lookahead}\comp \Varid{nil}\mathrel{=}\Varid{k1}\\\Varid{lookahead}\comp \Varid{cons}\mathrel{=}\Varid{k2}\;(\Varid{id}\;\Varid{x}\mathbin{<}\Varid{wc},\Varid{lookahead}\mathbin{>})\end{lcbr}\end{lcbr}}
      .
%
\just={ def nil e cons}
%
  \ensuremath{\begin{lcbr}\begin{lcbr}\Varid{wc}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\underline{\mathrm{0}}\\\Varid{wc}\;(\Varid{c}\mathbin{:}\Varid{l})\mathrel{=}\Varid{h2}\;(\Varid{c},(\Varid{wc}\;\Varid{t},\Varid{lookahead}\;\Varid{t}))\end{lcbr}\\\begin{lcbr}\Varid{lookahead}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{True}\\\Varid{lookahead}\;(\Varid{c}\mathbin{:}\Varid{t})\mathrel{=}\Varid{k2}\;(\Varid{c},(\Varid{wc}\;\Varid{t},\Varid{lookahead}\;\Varid{t}))\end{lcbr}\end{lcbr}}
      .
%
\just={ Lei fokkinga }
%
  <wc, lookahead> = (\ensuremath{\mathbin{<}[\mskip1.5mu \underline{\mathrm{0}},\Varid{gene2}\mskip1.5mu],[\mskip1.5mu \Varid{true},\Varid{sep}\comp \p1\mskip1.5mu]\mathbin{>}})
%
\just={ Lei da Troca}
%
  <wc, lookahead> = (\ensuremath{[\mskip1.5mu \mathbin{<}\underline{\mathrm{0}},\Varid{true}\mathbin{>},\mathbin{<}\Varid{gene2},\Varid{sep}\comp \p1\mathbin{>}\mskip1.5mu]}) onde : 
%  
  \ensuremath{\begin{lcbr}\begin{lcbr}\Varid{h1}\mathrel{=}\underline{\mathrm{0}}\\\Varid{h2}\mathrel{=}\uncurry{(\mathrel{\wedge})}\mathbin{.<}\neg \comp \Varid{sep}\comp \p1,\p2\comp \p2\mathbin{>}\end{lcbr}\\\begin{lcbr}\Varid{k1}\mathrel{=}\Conid{True}\\\Varid{k2}\mathrel{=}\Varid{sep}\comp \p1\end{lcbr}\end{lcbr}}
        .
%
\end{eqnarray*}
...
\\
\>[B]{}\Varid{outB\char95 tree}\;\Conid{Nil}{}\<[29]%
\>[29]{}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{outB\char95 tree}\;(\Conid{Block}\;\Varid{a}\;((\Varid{b},\Varid{c})\mathbin{:}\Varid{t}))\mathrel{=}i_2\;(\Varid{a},((\Varid{b},\Varid{c})\mathbin{:}\Varid{t})){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{inordB\char95 tree}\mathrel{=}\Varid{cataB\char95 tree}\;\alt{\Varid{nil}}{(\uncurry{(\plus )}\comp (\Varid{id}\times\Varid{concat}\comp (\map \;({}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{cons}))))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataBTree}\;\Varid{g}\mathrel{=}\Varid{cataB\char95 tree}\;\Varid{g}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\mathrm{1}\mathbin{+}\mathsf{B}\mbox{-}\mathsf{tree} \;\Conid{A}\times(\Conid{A}\times\mathsf{B}\mbox{-}\mathsf{tree} \;\Conid{A})\mathbin{*}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{cata}\;\Varid{g})}}
           \ar[l]_-{\ensuremath{\Varid{inB\char95 tree}}}
\\
     \ensuremath{\Conid{D}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\mathit C}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment largestBlock = }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment     let b = (uncurry max ) . (split (maximum.(map p2)) (length))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment     in cataBTree (either (const 0) (uncurry max.(id >< b)) )}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{Int}\times(\mathsf{B}\mbox{-}\mathsf{tree} \;\Conid{A}\times\Conid{Int})\mathbin{*}}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
...
\\[\blanklineskip]%
\>[B]{}\Varid{lsplitB\char95 tree}\mathbin{::}[\mskip1.5mu \Conid{Int}\mskip1.5mu]\to ()+([\mskip1.5mu \Conid{Int}\mskip1.5mu],[\mskip1.5mu (\Conid{Int},[\mskip1.5mu \Conid{Int}\mskip1.5mu])\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{lsplitB\char95 tree}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{lsplitB\char95 tree}\;\Varid{x}\mathrel{=}i_2\;(\Varid{separaM}\;\Varid{x}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{separaM}\mathbin{::}\Conid{Ord}\;\Varid{t}\Rightarrow [\mskip1.5mu \Varid{t}\mskip1.5mu]\to ([\mskip1.5mu \Varid{t}\mskip1.5mu],[\mskip1.5mu (\Varid{t},[\mskip1.5mu \Varid{t}\mskip1.5mu])\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{separaM}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathrel{=}([\mskip1.5mu \mskip1.5mu],[\mskip1.5mu (\Varid{x},[\mskip1.5mu \mskip1.5mu])\mskip1.5mu]){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{separaM}\;(\Varid{x}\mathbin{:}\Varid{y}\mathbin{:}\Varid{t})\mathrel{=}\mathbf{let}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{maior}\mathrel{=}\Varid{max}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{menor}\mathrel{=}\Varid{min}\;\Varid{x}\;\Varid{y}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{lista\char95 menores}\mathrel{=}\Varid{filter}\;(\lambda \Varid{n}\to \Varid{n}\mathbin{<}\Varid{menor})\;\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{e}\mathrel{=}\Varid{filter}\;(\lambda \Varid{n}\to \Varid{n}\mathbin{>}\Varid{menor}\mathrel{\wedge}\Varid{n}\mathbin{<}\Varid{maior})\;\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{lista\char95 maiores}\mathrel{=}\Varid{filter}\;(\lambda \Varid{n}\to \Varid{n}\mathbin{>}\Varid{maior})\;\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{in}\;(\Varid{lista\char95 menores},[\mskip1.5mu (\Varid{menor},\Varid{e}),(\Varid{maior},\Varid{lista\char95 maiores})\mskip1.5mu]){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gene}\mathrel{=}\alt{\Varid{nil}}{(\uncurry{(\plus )}\comp (\Varid{id}\times\Varid{concat}\comp (\map \;(\Varid{cons}))))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{qSortB\char95 tree}\mathrel{=}(\Varid{hyloB\char95 tree}\;\Varid{gene}\;\Varid{lsplitB\char95 tree}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{permuta}\;\Varid{lista}\mathrel{=}\mathbf{do}\;\{\mskip1.5mu (\Varid{h},\Varid{t})\leftarrow \Varid{getR}\;\Varid{lista};{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\Varid{resultado}\leftarrow \Varid{permuta}\;\Varid{t};{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\Varid{return}\;(\Varid{h}\mathbin{:}\Varid{resultado})\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\just={ Universal-+ }
%
  \ensuremath{\begin{lcbr}\Varid{permuta}\comp \Varid{nil}\mathrel{=}([\mskip1.5mu \Varid{nil},\Varid{cons}\mskip1.5mu]\comp (\Varid{id}\mathbin{+}\Varid{id}\times\Varid{f}))\comp i_1\\\Varid{permuta}\comp \Varid{cons}\mathrel{=}([\mskip1.5mu \Varid{nil},\Varid{cons}\mskip1.5mu]\comp (\Varid{id}\mathbin{+}\Varid{id}\times\Varid{f}))\comp i_2\end{lcbr}}
%
\just={ Absorção-+}
%
  \ensuremath{\begin{lcbr}\Varid{permuta}\comp \Varid{nil}\mathrel{=}([\mskip1.5mu \Varid{nil},\Varid{cons}\mskip1.5mu]\comp (\Varid{id}\mathbin{+}\Varid{id}\times\Varid{f}))\comp i_1\\\Varid{permuta}\comp \Varid{cons}\mathrel{=}([\mskip1.5mu \Varid{nil},\Varid{cons}\mskip1.5mu]\comp (\Varid{id}\mathbin{+}\Varid{id}\times\Varid{f}))\comp i_2\end{lcbr}} 
...
\just={ igualdade extensional }
%
  \ensuremath{\begin{lcbr}\Varid{permuta}\comp \Varid{nil}\;()\mathrel{=}([\mskip1.5mu \Varid{nil}\comp \Varid{id},\Varid{cons}\comp (\Varid{id}\times\Varid{f})\mskip1.5mu]\comp i_1)\;()\\\Varid{permuta}\comp \Varid{cons}\;(\Varid{h},\Varid{t})\mathrel{=}([\mskip1.5mu \Varid{nil}\comp \Varid{id},\Varid{cons}\comp (\Varid{id}\times\Varid{f})\mskip1.5mu]\comp i_2)\;(\Varid{h},\Varid{t})\end{lcbr}} 
%
\just={ Cancelamento-+}
%
  \ensuremath{\begin{lcbr}\Varid{permuta}\;(\Varid{nil}\;())\mathrel{=}(\Varid{nil}\comp \Varid{id})\;()\\\Varid{permuta}\;(\Varid{cons}\;(\Varid{h},\Varid{t}))\mathrel{=}(\Varid{cons}\comp (\Varid{id}\times\Varid{f}))\;(\Varid{h},\Varid{t})\end{lcbr}} 
% 
\just={ Def comp}
%
  \ensuremath{\begin{lcbr}\Varid{permuta}\;(\Varid{nil}\;())\mathrel{=}\Varid{nil}\;(\Varid{id}\;())\\\end{lcbr})\;(\Varid{permuta}\;(\Varid{cons}\;(\Varid{h},\Varid{t}))\mathrel{=}(\Varid{cons}\comp (\Varid{id}\times\Varid{f}))\;(\Varid{h},\Varid{t}))} 
% 
\just={ Def id}
%
  \ensuremath{\begin{lcbr}\Varid{permuta}\;(\Varid{nil}\;())\mathrel{=}\Varid{nil}\;(\Varid{id}\;())\\\Varid{permuta}\;(\Varid{cons}\;(\Varid{h},\Varid{t}))\mathrel{=}\Varid{cons}\;((\Varid{id}\times\Varid{f}))\;(\Varid{h},\Varid{t})\end{lcbr}} 
%
\just={ Definição ao ponto}
% 
  \ensuremath{\begin{lcbr}\Varid{permuta}\;(\Varid{nil}\;())\mathrel{=}\Varid{nil}\;()\\\Varid{permuta}\;(\Varid{cons}\;(\Varid{h},\Varid{t}))\mathrel{=}\Varid{cons}\;(\Varid{id}\;\Varid{h},(\Varid{f}\;\Varid{t}))\end{lcbr}} 
%  
\just={ Definição id}
%
  \ensuremath{\begin{lcbr}\Varid{permuta}\;(\Varid{nil}\;())\mathrel{=}\Varid{nil}\;(\Varid{id}\;())\\\Varid{permuta}\;(\Varid{cons}\;(\Varid{h},\Varid{t}))\mathrel{=}(\Varid{cons}\comp (\Varid{id}\times\Varid{f}))\;(\Varid{h},\Varid{t})\end{lcbr}} 
% 
\just={ Definição ao ponto}
%
  \ensuremath{\begin{lcbr}\Varid{permuta}\;(\Varid{nil}\;())\mathrel{=}\Varid{nil}\;()\\\Varid{permuta}\;(\Varid{cons}\;(\Varid{h},\Varid{t}))\mathrel{=}\Varid{cons}\;(\Varid{h},(\Varid{f}\;\Varid{t}))\end{lcbr}} 
%
\just={ Def-cons, Def-nil}
%
  \ensuremath{\begin{lcbr}\Varid{permuta}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]\\\Varid{permuta}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}(\Varid{h}\mathbin{:}(\Varid{f}\;\Varid{t}))\end{lcbr}} 
%  
\end{eqnarray*}
\subsubsection*{Código}
\begin{hscode}\SaveRestoreHook
